...
API REST que simula as funcionalidades de um aplicativo de investimento em ações (compra e venda de ativos), além de possibilitar depósitos e saques em uma conta digital.
